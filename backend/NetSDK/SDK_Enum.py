...
class EM_A_NET_EM_ACCESS_CTL_FACE_SERVICE(IntEnum):
    ...
    NET_EM_ACCESS_CTL_FACE_SERVICE_REMOVE = 3,  # 删除, pInbuf = NET_IN_ACCEbellSS_FACE_SERVICE_REMOVE , pOutBuf = NET_OUT_ACCESS_FACE_SERVICE_REMOVE;remove, pInbuf = NET_IN_ACCESS_FACE_SERVICE_REMOVE , pOutBuf = NET_OUT_ACCESS_FACE_SERVICE_REMOVE;
