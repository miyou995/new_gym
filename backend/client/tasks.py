...
def register_user(user_name, user_id, picture_path):
    ...
    face1.get_login_info(ip='192.168.1.2', port=37777, username='admin', password='mc091924')
    face2.get_login_info(ip='192.168.1.2', port=37777, username='admin', password='mc091924')
    result = face1.login()
    result2 = face2.login()
