...
urlpatterns = [
    ...
    path('abonnement-client/detail/<int:pk>/', renew_api_view, name="type-delete"),
    path('abonnement-client/renew/<int:pk>/', RenewABCView.as_view(), name="type-delete"),
